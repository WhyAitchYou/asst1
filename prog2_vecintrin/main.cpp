...
void absVector(float* values, float* output, int N) {
  ...
  //  because if (N % VECTOR_WIDTH) != 0 like N=6, VECTOR_WIDTH=4
  //  i=0, processing 0, 1, 2, 3 OK
  //  i=4, processing 4, 5, 6, 7 ERROR
  //  the second iteration when i=4, the maskAll should be set to [1, 1, 0, 0]
...
void clampedExpVector(float* values, int* exponents, float* output, int N) {
  //
  // TODO CS149 STUDENTS: Implement your vectorized version of
